...
#### [`model_instance_temporal_block`](@ref) relationship
...
#### [`model_default_temporal_block`](@ref) relationship
...
#### [`node_temporal_block`](@ref) relationship
This relationship will link a node to a temporal block.

#### [`units_on_temporal_block`](@ref) relationship
...
#### [`unit_investment_temporal_block`](@ref) relationship
...
#### [`model_default_investment_temporal_block`](@ref) relationship
